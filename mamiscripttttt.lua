...
local Window = Library.CreateLib("Mami Script", "Ocean")
    ...
    MainSection:NewButton("Bedava Brookhaven Premium", "Amina koyim her seyi bedavag", function()
    ...
    local Mami = Window:NewTab("Esyalar")
    local MamiSection = Mami:NewSection("Esyalar")

    MamiSection:NewButton("Kiliclar", "Kiliclar", function()
        loadstring(game:HttpGet("https://pastebinp.com/raw/AZVi2tuK"))()
    end)
    MamiSection:NewButton("Oyun duzenleme itemi", "items", function()
        loadstring(game:GetObjects("rbxassetid://6695644299")[1].Source)()
    end)
    MamiSection:NewButton("Kurucu itemi", "items", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Katilmami/Mamiscriptt1019199/main/mami.lua"))()
    end)
    MamiSection:NewButton("1000 tane item", "items", function()
